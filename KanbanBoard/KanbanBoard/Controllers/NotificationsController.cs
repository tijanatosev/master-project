...
namespace KanbanBoard.Controllers
{
    ...
    public class NotificationsController
    {
        ...
        public NotificationsController(ConnectionStringConfiguration connectionStringConfiguration)
        {
            notificationService = new NotificationService(connectionStringConfiguration);
        }
